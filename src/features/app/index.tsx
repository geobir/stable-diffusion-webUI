...
export default memo(function App() {
    ...
    let topArea = (
        <Flex overflow={"auto"} onMouseOver={ () => hoverItem(undefined) }>
            <SelectedView/>
            <SettingsEditor/>
        </Flex>
    );
    ...
    if (!backend) {
        topArea = (
            <Flex direction={"column"} gap={4} m={3} flex={1} justifyContent={"center"} alignItems={"center"}>
        ...
        <Flex direction={"column"} style={{ position:'relative', height: '100vh', maxWidth:'1900px', margin:'0 auto', padding:'0 !important' }} >
            <Tabs>
                ...
                <TabPanels>
                    ...
                    <TabPanel>
                        {/* https://www.npmjs.com/package/rext-image-editor */}
                    <p>WIP.</p>
                    </TabPanel>
                </TabPanels>
            </Tabs>
